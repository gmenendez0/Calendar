...
public class WholeDayEvent extends Event {
    ...
    //Constructor.
    public WholeDayEvent(int id, String title, String description, LocalDate startDate){
        super(id, title, description, startDate.atStartOfDay(), startDate.plusDays(ONE_DAY).atStartOfDay());
    }
