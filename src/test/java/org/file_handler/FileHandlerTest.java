...
public class FileHandlerTest {
    ...
    @Test
    public void sameAmountSavedAndRetrieved() throws IOException{
        amountInTheFile(2);
    }
    ...
    @Test
    public void newSameAmountSavedAndRetrieved() throws IOException{
        amountInTheFile(5);
    }

    @Test
    public void verifyTitleOfTheNewAppointment() throws IOException{
    ...
    @Test
    public void verifyDescriptionOfTheNewAppointment() throws IOException{
        List<Appointment> newJsonAppointment = calendar.recoverAppointments(fileHandler, pathJSON);
    ...
    @Test
    public void verifySubtypesOfTheNewAppointment() throws IOException{
        List<Appointment> newJsonAppointment = calendar.recoverAppointments(fileHandler, pathJSON);
